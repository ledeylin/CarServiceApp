...
public class Constants {
    ...
    protected static final String SERVICE_START_DATE = "start_date";
    protected static final String SERVICE_FINAL_DATE = "final_date";
    ...
    protected static final String CAR_MAKE = "car_make";
